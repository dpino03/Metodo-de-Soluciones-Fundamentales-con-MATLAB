...
% Definimos ahora la función nu(x) como el valor de u_A restringido a la
...
% consideraremos la función nu modificada aleatoriamente, lo que 
...
% Nótese que el ruido debe de ser fijo, y no depender de x, pues si no la
% función eta_pert no cumpliría con la regularidad suficiente para poder
% aplicar fmincon.
