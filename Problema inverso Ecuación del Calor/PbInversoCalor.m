...
% Definimos ahora la función eta(x,t) como el valor de de la derivada normal
...
for n = 1:M+1
    ...
    % consideraremos la función eta modificada aleatoriamente en cada 
    % tiempo,lo que representa el ruido en la medición. Para considerar 
    % una medición exacta,basta considerar pert = 0. El parámetro pert 
    % determniará el porcentaje de ruido aleatorio.
